# Generated by Django 5.1.1 on 2024-09-19 06:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.IntegerField(choices=[(2, 'ORDER_PROSSED'), (3, 'ORDER_DELEVERED'), (4, 'ORDER_REJECTED')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='added_carts', to='production.product')),
            ],
        ),
    ]
